...
async def register_user(
    ...
    Args:
        ...
        background_tasks (BackgroundTasks): Fast API Background tasks to execute.
        db (AsyncSession): The asynchronous database session.
        email_sender (EmailSenderInterface): An instance of EmailSender configured with the appropriate email settings.
...
async def activate_account(
    ...
    Args:
        ...
        db (AsyncSession): The asynchronous database session.
        background_tasks Background tasks to send email notifications.
        email_sender (EmailSenderInterface): Email sender instance.
...
async def request_password_reset_token(
    ...
    Args:
        ...
        background_tasks (BackgroundTasks): tasks to send email notifications.
        db (AsyncSession): The asynchronous database session.
        email_sender (EmailSenderInterface): Email sender instance.
